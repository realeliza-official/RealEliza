  ...
  return (
    <>
      ...
      <div className="py-5 px-4 flex flex-col gap-3 md:w-unit-9xl md:mx-auto md:gap-5 lg:w-[892px] lg:gap-8">
        <h1 className="text-2xl font-medium">Terms of Service for RealEliza</h1>
        <p>
        ...
        <p>
          Welcome to RealEliza. These terms and conditions outline the rules and
          regulations for the use of RealEliza&apos;s website and services. By
          ...
          RealEliza&apos;s website and services if you do not accept all of the
          terms and conditions stated on this page.
        </p>

        <h2 className="text-xl font-medium">License</h2>
        <p>
          Unless otherwise stated, RealEliza owns the intellectual property rights
          for all material on RealEliza. All intellectual property rights are
          reserved. You may access this from RealEliza for your own personal use
        ...
        <ul>
          ...
          <li>
            ...
            the interfaces provided by RealEliza.
          </li>
        </ul>

        <h2 className="text-xl font-medium">Indemnification</h2>
        <p>
          You agree to indemnify, defend and hold harmless RealEliza, its officers,
        ...
        <p>
          RealEliza reserves the right to terminate your access to the site and the
