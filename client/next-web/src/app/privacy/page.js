  ...
  return (
    <>
      ...
      <div className="py-5 px-4 flex flex-col gap-3 md:w-unit-9xl md:mx-auto md:gap-5 lg:w-[892px] lg:gap-8">
        <h1 className="text-2xl font-medium">Privacy Notice for RealEliza</h1>
        <p>
        ...
        <p>
          Thank you for using RealEliza. We respect your privacy and want to
        ...
        <p>
          ...
          please contact us at privacy@realeliza.ai.
        </p>
      </div>
      <Footer />
    </>
