...
package ai.realeliza.app.ui.vm

import ai.realeliza.app.RealElizaApplication
...
import ai.realeliza.app.util.GSON
...
object GlobalVM : ViewModel() {
    ...
    private val sp by lazy {
        RealElizaApplication.applicationCtx.getSharedPreferences(
            "global",
