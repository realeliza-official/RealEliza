    ...
    static var previews: some View {
        ConfigView(options: [
            .init(id: "god",
                  name: "Mythical god",
                  description: "Rogue",
                  imageUrl: URL(string: "https://storage.googleapis.com/assistly/static/realeliza/loki.png")!,
                  authorName: "",
                  source: "default"),
            .init(id: "hero",
                  name: "Anime hero",
                  description: "Noble",
                  imageUrl: URL(string: "https://storage.googleapis.com/assistly/static/realeliza/raiden.png")!,
                  authorName: "",
                  source: "default"),
            .init(id: "ai",
                  name: "Realtime AI",
                  description: "Kind",
                  imageUrl: URL(string: "https://storage.googleapis.com/assistly/static/realeliza/ai_helper.png")!,
                  authorName: "",
                  source: "default")],
