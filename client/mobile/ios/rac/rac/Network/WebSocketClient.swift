...
class WebSocketClient: NSObject, WebSocket, URLSessionWebSocketDelegate {
    ...
    private func mapCharacterToImageUrl(characterName: String) -> URL? {
        ...
        if characterName.contains("Elon") {
            return  URL(string: "https://storage.googleapis.com/assistly/static/realeliza/elon.jpeg")!
        } else if characterName.contains("Character") {
            return  URL(string: "https://storage.googleapis.com/assistly/static/realeliza/ai_helper.png")!
        } else if characterName.contains("Loki") {
            return  URL(string: "https://storage.googleapis.com/assistly/static/realeliza/loki.png")!
        } else if characterName.contains("Pi") {
            return  URL(string: "https://storage.googleapis.com/assistly/static/realeliza/pi.jpeg")!
        } else if characterName.contains("Raiden") {
            return  URL(string: "https://storage.googleapis.com/assistly/static/realeliza/raiden.png")!
        }
        return URL(string: "https://storage.googleapis.com/assistly/static/realeliza/\(characterName.replacingOccurrences(of: " ", with: "_").lowercased()).jpg")
    }
